      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="font-outfit mt-4 text-3xl font-black tracking-tight text-white sm:text-4xl">
            Tudo o que você recebe no{" "}
            <em className="not-italic text-cyan-400">primeiro ano</em>
          </h2>
          <p className="mt-3 max-w-lg text-sm leading-relaxed text-white/50">
            Sem pegadinha, sem mensalidade escondida. Uma única vez e pronto.
          </p>
        </motion.div>
    ...
    <section className="px-6 py-24">
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <h2 className="font-outfit mt-4 text-3xl font-black tracking-tight text-white sm:text-4xl">
            Do zero ao ar em{" "}
            <em className="not-italic text-cyan-400">24 horas</em>
          </h2>
        </motion.div>
          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="flex flex-col items-center">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 text-sm font-black text-white">
                  {s.n}
                </div>
                {i < steps.length - 1 && (
                  <div className="mt-1 w-px flex-1 bg-gradient-to-b from-blue-600/40 to-transparent" style={{ minHeight: 40 }} />
                )}
              </div>
              <div className="pb-10">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="font-outfit mt-4 text-3xl font-black tracking-tight text-white sm:text-4xl">
            ...
            <em className="not-italic text-cyan-400">ideal para você</em>
          </h2>
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-white/50">
            Todos os planos incluem exatamente os mesmos recursos. Só muda a forma de pagar.
          </p>
        </motion.div>
          ...
          {planos.map((p, i) => (
            <motion.div
              ...
              className={`relative flex flex-col rounded-2xl border p-7 transition hover:-translate-y-1 ${
                p.destaque
                  ? "border-cyan-500/40 bg-gradient-to-b from-cyan-500/[0.08] to-blue-600/[0.06]"
                  : "border-white/[0.06] bg-white/[0.03]"
              }`}
            >
              {p.badge && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 px-4 py-1 text-xs font-bold text-white">
                  {p.badge}
                </div>
              )}
              ...
              <div className="mt-3">
                <span className="font-outfit text-3xl font-black text-white">{p.price}</span>
              </div>
              ...
              <a
                ...
                className={`mt-auto block rounded-xl py-3 text-center text-sm font-bold text-white transition hover:-translate-y-0.5 ${
                  p.destaque
