          ...
          >
            ...
            <div className="flex items-start justify-between px-6 py-5 border-b border-white/5 shrink-0">
              <div className="flex-1 min-w-0 pr-3">
                ...
                <p className="text-sm text-gray-500 truncate mt-0.5">{cliente.contact_name || '—'}</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="px-6 py-5 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                  ...
                  <div>
                    <p className="text-[9px] font-black uppercase tracking-widest text-gray-700 mb-1">Email</p>
                    {cliente.email ? (
                      <a
                  ...
                  />
                  <div>
                    <p className="text-[9px] font-black uppercase tracking-widest text-gray-700 mb-1">Status</p>
                    {statusCfg ? (
