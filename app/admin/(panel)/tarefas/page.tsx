...
const INPUT_CLASS = 'w-full bg-[#0D0D0D] border border-white/10 rounded-xl px-3 py-2.5 text-sm text-white placeholder-[#E9E9E9] focus:outline-none focus:border-cyan-500/40 transition-all';
