      ...
      <div className="w-full max-w-md bg-[#0C0C0C] border border-white/10 rounded-2xl shadow-2xl">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-[9px] font-black uppercase tracking-widest text-[#F0F0F0] mb-1.5 block">Tipo</label>
            ...
            <div>
              <label className="text-[9px] font-black uppercase tracking-widest text-[#F0F0F0] mb-1.5 block">Canal</label>
              <input className={INPUT_CLASS} placeholder="WhatsApp, Email..." value={form.channel} onChange={e => setForm(f => ({ ...f, channel: e.target.value }))} />
            </div>
          </div>
          <div>
            <label className="text-[9px] font-black uppercase tracking-widest text-[#F0F0F0] mb-1.5 block">Prazo</label>
                  ...
                  <tr key={tarefa.id} className={`border-b border-white/5 last:border-0 transition-colors hover:bg-white/[0.025] ${tarefa.done ? 'opacity-50' : ''}`}>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-1.5">
                        <button onClick={() => setEditTarefa(tarefa)} className="w-7 h-7 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 flex items-center justify-center text-[#F6F6F8] hover:text-white transition-all"><Pencil className="w-3 h-3" /></button>
