      ...
      {projeto && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-screen w-[400px] z-50 bg-[#0B0B0B] border-l border-white/10 flex flex-col shadow-2xl"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {/* Financeiro */}
              <div className="px-6 py-5 border-b border-white/5">
                <p className="text-[9px] font-black uppercase tracking-widest text-gray-700 mb-4">
                  Financeiro
                </p>
              ...
              {(projeto.scope || projeto.notes) && (
                <div className="px-6 py-5 space-y-4">
                  {projeto.scope && (
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-widest text-gray-700 mb-2">Escopo</p>
                      <p className="text-sm text-gray-400 leading-relaxed">{projeto.scope}</p>
                    </div>
                  )}
                  {projeto.notes && (
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-widest text-gray-700 mb-2">Notas</p>
