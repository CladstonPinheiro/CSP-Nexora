...
export const metadata: Metadata = {
  ...
  description:
    "Seu negócio no Google Meu Negócio merece um site profissional. Entregamos em 24h com domínio .com.br, e-mails profissionais e hospedagem inclusa por 1 ano.",
  openGraph: {
    title: "Site Profissional em 24h | CSP Nexora",
    ...
    <main className="min-h-screen bg-[#050505]">
      ...
      <footer className="border-t border-white/[0.05] px-6 py-10 text-center">
        ...
        <p className="mt-1 text-xs text-white/30">
          📧 contato@cspnexora.com.br · 📱 (61) 98420-2578
        </p>
        <p className="mt-4 text-xs text-white/20">
          © {new Date().getFullYear()} CSP Nexora. Todos os direitos reservados.
        </p>
      </footer>
      ...
      <a
        ...
        className="fixed bottom-7 right-7 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/40 transition hover:scale-110"
      >
